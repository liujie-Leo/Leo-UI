<template>
  <div class="h-screen w-screen flex justify-center items-center home ">
    <div class="content-box ">
      <div class="title text-gray-700 text-3xl font-bold tracking-wide text-center">Ls - Componentssss</div>
      <div class="mt-3">
